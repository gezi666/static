...
function renderData (res,index)  {
  ...
  var html = '<li class="list-li">'
              ...
              +'<a class="icon iconfont icon-github1 edit-json" href="https://github.com/jusfoun-FE/static/edit/master/projectManage/configInfo/'+jsonUrl+'" title="编辑" target="_blank"> <i></i></a>';
              if(!delay){
